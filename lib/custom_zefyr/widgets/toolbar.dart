...
class ZefyrToolbarState extends State<ZefyrToolbar>
  ...
  List<Widget> _buildButtons(BuildContext context) {
    final buttons = <Widget>[
      buildButton(context, ZefyrToolbarAction.galleryImage, onPressed: _pickFromGallery),
      buildButton(context, ZefyrToolbarAction.coverImage),
      buildButton(context, ZefyrToolbarAction.location)
    ];
    return buttons;
  }
}

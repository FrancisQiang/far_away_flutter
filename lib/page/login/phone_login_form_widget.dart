        ...
        children: [
          ...
          Container(
            ...
            child: AnimatedLoginButton(
              ...
              login: () {
                ApiMethodUtil.instance.mobileRegisterOrLogin(
                    success: (data) async {
                      ResponseBean responseBean =
                      ResponseBean.fromJson(data);
                      if (responseBean.isSuccess()) {
                        UserTokenBean userTokenBean =
                        UserTokenBean.fromJson(responseBean.data);
                        // 暂存token 通过token获取用户信息
                        Response<dynamic> userInfoResponse = await ApiMethodUtil.getUserInfo(token: userTokenBean.token);
                        ResponseBean response = ResponseBean.fromJson(userInfoResponse.data);
                        UserInfoBean userInfoBean = UserInfoBean.fromJson(response.data);
                        SharedPreferenceUtil.instance.setString(SharedPreferencesKeys.userInfo, userInfoBean.toJson().toString());
                        SharedPreferenceUtil.instance.setString(SharedPreferencesKeys.userToken, userTokenBean.token);
